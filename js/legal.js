...
(function () {
    ...
    I18n.add('zh', {
        ...
        'privacy.li3': '所有测试（运气测试、MBTI、色彩测试等）完全在你的浏览器本地运行，结果不会发送到任何服务器',
    ...
    I18n.add('en', {
        ...
        'privacy.li3': 'All tests run entirely in your browser — nothing is sent to servers',
    ...
    I18n.add('zh', {
        ...
        'disc.h2_1': '🎯 我们是做什么的',
        'disc.p1': '我们做有趣的互动小测试！包括每日运气测试、MBTI 性格测试、幸运色彩测试、趣味性格标签等。这些测试的目的很单纯——让你开心一下，给无聊的日子加点调料🌶️',
        'disc.h2_2': '⚡ 划重点',
    ...
    I18n.add('en', {
        ...
        'disc.p1': 'Fun interactive quizzes — daily luck, MBTI, color personality, and more. Just for laughs! 🌶️',
